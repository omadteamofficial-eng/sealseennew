...
$buyurtmak = json_encode([
  'resize_keyboard'=>true,
  'inline_keyboard'=>[
  [['text'=>"📡Kanalimiz📡", 'url'=>"https://telegram.me/UzBotGroup"],['text'=>"👥Guruhimiz👥", 'url'=>"https://telegram.me/UBG_Chat"]], 
  [['text'=>"👨‍💻Admin👨‍💻", 'url'=>"https://telegram.me/MrShefPC"]], 
  ]
  ]); 
...
$channeli = json_encode([
  ...
  'inline_keyboard'=>[
  [['text'=>"📡Kanalimiz📡", 'url'=>"https://telegram.me/UzBotGroup"],['text'=>"👥Guruhimiz👥", 'url'=>"https://telegram.me/UBG_chat"]],
  [['text'=>"👑KING👑", 'url'=>"https://telegram.me/MrShefPC"]],
  ]
  ]);
...
$yanak = json_encode([
  ...
  'inline_keyboard'=>[
  [['text'=>"👨‍💻Admin👨‍💻", 'url'=>"https://telegram.me/MrShefPC"]],
  [['text'=>"👥Guruhimiz👥", 'url'=>"https://telegram.me/UBG_chat"],['text'=>"📡Kanalimiz📡", 'url'=>"https://telegram.me/UzBotGroup"]],
  ]
  ]);
...
$ssa = json_decode(file_get_contents('data.json'),1);
 $status = bot('getChatMember',['chat_id'=>'@UzBotGroup','user_id'=>$from_id])->result->status;
        if($status == 'left'){
